...
# Form implementation generated from reading ui file 'PMAGUI2.ui'
#
# Created by: PyQt5 UI code generator 5.9.2
#
# WARNING! All changes made in this file will be lost!
'''
2nd version of GUI to test PMA, currently serves the purpose of dragging the
motion control around, updated to (hopefully) handle xy with threading
-Luke Weston Feb 2020
'''

import threading
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtCore import Qt, pyqtProperty, QObject, pyqtSignal, QThread
...
'''
#previous attempt to accept wasd, now using threading
class Window(QtWidgets.QMainWindow):
    #only way I found to get keypressed working
    #would not allow for movement here or by going back to the UI
    def __init__(self):
...
'''
#Using QThreads instead of daemons may have potential, but need to research
class WASD_Thread(QThread):
    def __init__(self):
...
if __name__ == "__main__":
    ...
    KeyWatch = threading.Thread(name = 'daemon', target = KeyWatch)
    KeyWatch.setDaemon(True)
    KeyWatch.start()
    MainWindow = QtWidgets.QMainWindow()
    #MainWindow = Window() #UI startup for keypress processer
    ui = Ui_MainWindow()
